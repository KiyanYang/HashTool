...
namespace HashTool.ViewModel
{
    internal class MainWindowViewModel : ObservableObject
    {
        public MainWindowViewModel()
        {
            ...
            mainInput = new();
            progressBarSingle = new();
            progressBarMulti = new();
        ...
        private ProgressBarSingleModel progressBarSingle;
        private ProgressBarMultiModel progressBarMulti;
        ...
        public ProgressBarSingleModel ProgressBarSingle
        {
            get => progressBarSingle;
            set => SetProperty(ref progressBarSingle, value);
        }
        public ProgressBarMultiModel ProgressBarMulti
        {
